...
<div class="container mt-0">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-4 text-center" style="font-weight: bold;">Slider</h2>
            <!-- Table -->
            <table class="table table-hover table-striped table-bordered text-center" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 4px; overflow: hidden;">
                ...
                <tbody>
                    <?php $no = 0; ?>
                    <?php foreach ($slidercontroller as $item): ?>
                    <tr>
                        <td><?= $no += 1; ?></td>
                        ...
                        <td class="text-center align-middle" style="height: 100px;">
                            <div class="d-flex justify-content-center align-items-center" style="gap: 4px;">
                                <a href="/slidercontroller/<?= $item['id'] ?>/edit" 
                                ...
                                <form action="/slidercontroller/<?= $item['id'] ?>" method="POST" 
        ...
        <div class="col-12">
            <?= $pager->links('slidercontroller', 'custom_pagination') ?>
        </div>
    </div>
</div>
<?= $this->endSection() ?>
